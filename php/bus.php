...
{
	$stmt = $conn->prepare("insert into bus(departure, arrival, dtime, atime, fclass, economy,name ) values(?,?,?,?,?,?,?)");
	$stmt->bind_param("ssssiis", $departure , $arrival, $dtime, $atime, $fclass , $economy, $name);
	$stmt->execute();
...
<img src="images/bt.png"><span>Brand Travels</span>
    ...
    <a href="../gallery.html"><i class="fa fa-fw fa-info"></i> About Us</a>
    <a href="#bus"><i class="fa fa-fw fa-book"></i> Booking</a>
